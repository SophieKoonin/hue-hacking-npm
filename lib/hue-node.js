...
var hue = function () { 
    ...
    var shortFlashType = 'select',
        ...
        postJSON = function(url, callback, data) {
            needle.post(url, JSON.stringify(data), callback);
            return data;
        },
        ...
        post = function(destination, data, success) {
            var callback = success || null,
                stateData = null;
            callback = null === callback ? apiSuccess : success;

            return postJSON(destination, callback, data);
        },
        ...
        buildStateURL = function(lampIndex /* Number */) {
            return buildLampQueryURL(lampIndex) + '/state/';
        },

        /**
         * Convenience function used to build a query URL for all lights
         *
         * @return {String} URL to put state to a lamp.
         */
        buildLightsUrl = function() {
            return baseApiUrl + '/lights/';
        },
        /**
         * Convenience function used to build a state URL for a provided Hue lamp
         * group.
        ...
        buildGroupActionURL = function(groupIndex /* number */) {
            return buildGroupIndexURL(groupIndex) + '/action/';
        },
        /**
         * Convenience function used to build a state URL for a provided Hue lamp
         * group.
         ...
         * @return {String} URL to trigger a group action.
         */
        buildGroupIndexURL = function(groupIndex /* number */) {
            return buildGroupURL() + groupIndex;
        },


        /**
         * Convenience function used to build a state URL for all groups
         *
         * @return {String} URL as basis for group queries.
         */
        buildGroupURL = function() {
        ...
        createGroup = function(name, lights) {
            ...
            return post(buildGroupURL(), data);
        },
        /**
        ...
        buildLampQueryURL = function(lampIndex /* Number */) {
            return buildLightsUrl() + lampIndex;
        },
    ...
    return {
         ...
         */
        getStatusSingle: function(lampIndex /* Number */) {
            return get(buildLampQueryURL(lampIndex));
        },
        /**
         * Get the status of a group of lights.
         */
        getStatusGroup: function(groupIndex /* Number */) {
            return get(buildGroupQueryURL(groupIndex));
        },
        ...
        getStatusAll: function(){
            return get(buildLightsUrl());
        },

        /**
         * Get the status of all groups
         */
        getStatusGroups: function() {
            return get(buildGroupURL());
        },
        ...
        setGroupColor: function(colour, groupIndex) {
            var state = buildXYState(colors.getCIEColor(colour));
        ...
        turnOnGroup: function(groupIndex) {
            return putGroupAction(groupIndex, onState);
        },

        turnOffGroup: function(groupIndex) {
            return putGroupAction(groupIndex, offState);
        },
        /**
        ...
        createNewGroup: function(name, lights){
            return createGroup(name, lights);
        }
    };
}();
